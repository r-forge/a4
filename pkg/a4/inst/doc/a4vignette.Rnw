...
<<annotationTableLimma, results = tex, fig = FALSE, echo = FALSE, term = FALSE, keep.source=TRUE>>=
  ...
  xTabAnnot <- xtable(tabAnnot, digits = 2,
...
<<plotComb2Samples, fig = FALSE, term = FALSE, keep.source=TRUE>>=
...
<<plotComb2SamplesWithAnnotation, fig = FALSE, term = FALSE, keep.source=TRUE>>=
